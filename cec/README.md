...
|---|---|---|
| `CEC_BASE_DEVICE` | `0` | Logical CEC address of the device the adapter is connected to (0 = TV) |
...
Commands are sent as newline-terminated strings to `/run/cec-uinput/cmd.sock`:
